  ...
  switch (categoryId) {
    case 'morning':
      return [
        ...
        const Azkar(
          ...
          reference: 'ابن ماجه ٢:١٢٧٢',
          repeatCount: 3,
          virtue: 10,
        ),
        const Azkar(
          id: 'morning_6',
          arabicText: 'رَضِيتُ بِاللهِ رَبًّا، وَبِالْإِسْلاَمِ دِينًا، وَبِمُحَمَّدٍ صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ نَبِيًّا',
        ...
        const Azkar(
          id: 'morning_8',
          arabicText: 'حَسْبِيَ اللهُ لاَ إِلَهَ إِلاَّ هُوَ عَلَيْهِ تَوَكَّلْتُ وَهُوَ رَبُّ الْعَرْشِ الْعَظِيمِ',
          translation: 'Allah is sufficient for me, there is none worthy of worship except Him, I have placed my trust in Him and He is the Lord of the Mighty Throne',
        ...
        const Azkar(
          id: 'morning_9',
          arabicText: 'بِسْمِ اللهِ الَّذِي لاَ يَضُرُّ مَعَ اسْمِهِ شَيْءٌ فِي الْأَرْضِ وَلاَ فِي السَّمَاءِ وَهُوَ السَّمِيعُ الْعَلِيمُ',
        ...
        const Azkar(
          ...
          translation: 'O Allah, You are my Lord, there is none worthy of worship except You, You created me and I am Your servant',
          reference: 'البخاري ٧:١٥٨',
          repeatCount: 1,
          virtue: 10,
        ),
        const Azkar(
    ...
    case 'evening':
      return [
        const Azkar(
          id: 'evening_1',
          arabicText: 'أَمْسَيْنَا وَأَمْسَى الْمُلْكُ للهِ، وَالْحَمْدُ للهِ، لَا إِلَهَ إِلاَّ اللهُ وَحْدَهُ لاَ شَرِيكَ لَهُ',
        ...
        const Azkar(
          id: 'evening_8',
          arabicText: 'رَضِيتُ بِاللهِ رَبًّا، وَبِالْإِسْلَامِ دِينًا، وَبِمُحَمَّدٍ صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ نَبِيًّا',
          translation: 'I am pleased with Allah as my Lord, with Islam as my religion and with Muhammad (peace be upon him) as my Prophet',
          reference: 'أبو داود ٤:٣١٨',
          repeatCount: 3,
          virtue: 10,
